...
@pytest.mark.asyncio
async def test_fetch_jellyfin_movies_network_error(mock_httpx_client: Mock, mock_env_vars) -> None:
...
@pytest.mark.asyncio
async def test_fetch_jellyfin_movies_http_404(mock_httpx_client: Mock, mock_env_vars) -> None:
    """404 → FETCH_FAILED."""
    mock_response = Mock()
